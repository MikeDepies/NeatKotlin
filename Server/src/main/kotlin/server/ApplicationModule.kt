...
fun NeatExperiment.generateInitialPopulation2(
    ...
    val assignConnectionRandomWeight = assignConnectionRandomWeight(7f)
...
//
//    }
    val mutateBias = getMutateBiasConnections(1f, 2.5f, 7f)
...
fun simulation(
    ...
    val speciesGeneList = manifest.scoreLineageModel.speciesMap.values.map { it.toGene() }.filter { it.species.id > 2000 }
