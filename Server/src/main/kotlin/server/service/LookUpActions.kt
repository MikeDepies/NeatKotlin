...
ZITABATA = 374""".split("\n")
    ...
    println("${map.size}")
    val actions = listOf(
        64, 15, 350, 18, 63, 24, 235, 57, 20, 352, 15, 44, 50, 42, 66, 71, 14, 63, 18, 57, 44, 45, 47, 48, 49, 64, 15, 53, 57, 42, 40, 344, 346, 18, 350, 24, 28, 66, 71, 44, 45, 47, 48, 49, 57, 350, 64, 235, 53, 14, 15, 44, 45, 47, 48, 42, 64, 350, 352, 235, 57, 15, 53, 63, 42, 64, 44, 45, 47, 48, 49, 57, 15, 14, 64, 42, 350, 352, 20, 50, 63, 57, 53, 15, 344, 346, 352, 350, 64, 24, 63, 53, 42, 25, 67, 69, 74, 40, 64, 15, 14, 233, 24, 26, 28, 360, 42, 18, 53, 64, 27, 347, 349, 66, 71, 15, 14, 53, 57, 44, 45, 47, 48, 42, 40, 64, 344, 346, 350, 235, 57, 15, 14, 352, 42, 40, 64, 18, 212, 57, 15, 350, 20, 352, 42, 40, 64, 235, 57, 15, 24, 26, 67, 72, 42, 64, 44, 45, 47, 48, 49, 57, 40, 350, 53, 352, 15, 64, 14, 344, 346, 42, 40, 63, 53, 15, 64, 183
    ).map { map[it.toString()] }
    actions.forEach {
        println(it)
    }
