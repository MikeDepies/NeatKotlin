...
ZITABATA = 374""".split("\n")
    ...
    println("${map.size}")
    val actions = listOf(
        233, 179, 18, 234, 64, 57, 44, 45, 47, 191, 195, 55, 226, 183, 187, 15, 24, 66, 18, 67, 60, 64, 44, 45, 47, 341, 342, 343, 20, 20, 20, 20, 20, 50, 14, 15, 40, 24, 68, 226, 183, 197, 44, 191, 195, 187, 341, 342, 27, 344, 345, 346, 66, 353, 355, 357, 15, 56, 55, 226, 183, 195, 44, 45, 47, 191, 347, 348, 349, 179, 14, 18, 15, 341, 342, 343, 24, 25, 66, 226, 183, 196, 44, 45, 47, 191, 195, 14, 212, 341, 342, 343, 15, 24, 55, 18, 25, 344, 345, 179, 66, 226, 183, 196, 182, 191, 195, 341, 342, 2
    ).map { map[it.toString()] }
    actions.forEach {
        println(it)
    }
