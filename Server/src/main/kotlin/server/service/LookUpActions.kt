...
ZITABATA = 374""".split("\n")
    ...
    println("${map.size}")
    val actions = listOf(
        24, 25, 367, 213, 221, 341, 342, 343, 233, 367, 18, 15, 341, 342, 343, 233, 24, 26, 367, 40, 341, 342, 343, 15, 24, 25, 213, 221, 341, 342, 343, 40, 15, 213, 221, 341, 342, 343, 14, 367, 40, 15, 341, 342, 343, 234, 367, 40, 24, 26, 15, 341, 342, 343, 367, 24, 18, 40, 213, 216, 217, 221, 341, 342, 343, 367, 40, 15, 14, 18, 24, 26, 213, 219, 341, 342, 343, 367, 221, 40, 233, 341, 342, 343, 367, 24, 40, 26, 341, 342, 343, 347, 349, 367, 40, 341, 342, 343, 15, 24, 25, 367, 40
    ).map { map[it.toString()] }
    actions.forEach {
        println(it)
    }
