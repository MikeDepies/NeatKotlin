...
class InputEmbederPacked:
    ...
    def embed_input(self, gamestate: GameState) -> np.ndarray:
        state: np.ndarray = np.zeros((1, 143))
        player0: PlayerState = gamestate.players[self.player_index]
        statePosition = 0
        state[0, statePosition] = player0.controller_state.button[melee.Button.BUTTON_A]
        statePosition +=1
        state[0, statePosition] = player0.controller_state.button[melee.Button.BUTTON_B]
        statePosition +=1
        state[0, statePosition] = player0.controller_state.button[melee.Button.BUTTON_Y]
        statePosition +=1
        state[0, statePosition] = player0.controller_state.button[melee.Button.BUTTON_Z]
        statePosition +=1
        state[0, statePosition] = player0.controller_state.main_stick[1]
        statePosition +=1
        state[0, statePosition] = player0.controller_state.main_stick[1]
        statePosition +=1
        state[0, statePosition] = player0.controller_state.c_stick[0]
        statePosition +=1
        state[0, statePosition] = player0.controller_state.c_stick[1]
        statePosition +=1
        state[0, statePosition] = player0.controller_state.l_shoulder
        statePosition +=1
        statePosition = self.applyPlayerState(player0, state, statePosition)
